...
def map_receipt_fields(analysis: Any) -> ReceiptExtraction:
    ...
    return ReceiptExtraction(
        currency=_extract_value(
            fields, ["currency", "receiptCurrency", "currencyCode"]
        ),
        ...
        document_type=_extract_value(
            fields, ["documentType", "document_type", "documentType"]
        ),
        ...
        invoice_total=_extract_value(
            fields, ["invoiceTotal", "invoice_total", "total", "receiptTotal"]
        ),
        ...
        total_tax=_extract_value(
            fields, ["totalTax", "total_tax", "tax", "taxTotal"]
        ),
