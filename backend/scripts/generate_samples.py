...
CASES = (
    ...
    InvoiceCase(
        "04-fr-happy-classic.pdf",
        "fr",
        "classic",
        "happy_path",
        "Lumière Technique S.A.S.",
        "FR40303265045",
        CUSTOMER_VAT_ID,
        "FR-2026-4017",
        "PO-4004",
    ...
    InvoiceCase(
        "11-fr-scan-quality.png",
        "fr",
        "compact",
        "scan_quality",
        "Clair Nettoyage S.A.S.",
        "FR61954506077",
        CUSTOMER_VAT_ID,
        "FR-2026-1111",
        "PO-4011",
